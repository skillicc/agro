...
class PurchaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'items.*.package_qty' => 'nullable|numeric|min:0',
            'items.*.unit_per_package' => 'nullable|numeric|min:0',
        ...
        try {
            $purchase = Purchase::create([
                ...
                'reference_no' => 'REF-' . date('Ymd') . '-' . str_pad(Purchase::whereDate('created_at', today())->count() + 1, 4, '0', STR_PAD_LEFT),
                'date' => $request->date,
